...
import { AuditIPLocationService } from './audit-ip-location.service';
...
export class AuditService {
  ...
  constructor(
    ...
    @Inject(forwardRef(() => AuditIPLocationService))
    private readonly auditIPLocationService: AuditIPLocationService,
  ) {}
  ...
  async log(...argumentsArray: unknown[]): Promise<void> {
    ...
    auditLog.ip = req.ip;
    auditLog.region = this.auditIPLocationService.query(req.ip);
